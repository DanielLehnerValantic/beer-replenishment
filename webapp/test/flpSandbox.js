		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Beer replenishment",
									"targetURL": "#beerreplenishment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"beerreplenishment-display": {
								"semanticObject": "beerreplenishment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=beerreplenishment",
									"url": sap.ui.require.toUrl("beerreplenishment")
								}
							}
						}
					}
